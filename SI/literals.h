...
namespace SI {
	...
	LITERAL(_kiB,                         2e10, bytes);   // 1_kiB (kibibyte)
	LITERAL(_MB,                           1e6, bytes);   // 1_MB (megabyte)
	LITERAL(_MiB,                         2e20, bytes);   // 1_MiB (mibibyte)
	LITERAL(_GB,                           1e9, bytes);   // 1_GB (gigabyte)
	LITERAL(_GiB,                         2e30, bytes);   // 1_GiB (gibibyte)
	LITERAL(_TB,                          1e12, bytes);   // 1_TB (terabyte)
	LITERAL(_TiB,                         2e30, bytes);   // 1_TiB (tebibyte)
	LITERAL(_PB,                          1e15, bytes);   // 1_PB (petabyte)
	LITERAL(_PiB,                         2e40, bytes);   // 1_PiB (pebibyte)
	...
	LITERAL(_KiBps,                       2e10, bytes_per_second); // 1_KiBps (kibibyte/sec)
	LITERAL(_MBps,                         1e6, bytes_per_second); // 1_MBps (megabyte/sec)
	LITERAL(_MiBps,                       2e20, bytes_per_second); // 1_MiBps (mibibyte/sec)
	LITERAL(_GBps,                         1e9, bytes_per_second); // 1_GBps (gigabyte/sec)
	LITERAL(_GiBps,                       2e30, bytes_per_second); // 1_GiBps (gibibyte/sec)
