...
//SET(Φ_0,      2.067833848e-15, weber); // (the symbol)
...
//SET(h_2me,              3.6369475e-4, units::m2 / units::s); // quantum of circulation
...
//SET(c_1,       3.741771852e-16, units::W * units::m2); // first radiation constant
//SET(c_1L,      1.191042972e-16, units::W * units::m2 / units::sr); // first radiation constant for spectral radiance
...
SET(g_0,                9.80665, meters_per_second2); // standard acceleration of gravity
