...
int main() {
    ...
    print("\n10. What's the frequency and wavelength of the high 'c' music note? ");
    ...
    print("\n11. What's the population density on Earth (people per km² of land area)? ");
    ...
    print("\n12. How much land area would be available for each person on Earth? ");
    ...
    print("\n14. Which moons are greater than Earth's moon? ");
    ...
    print("\n15. How long takes a 1TB download at 100MBit speed? ");
    auto file_size = 1_TB;
    ...
    print("\n16. What's an aircraft's glide path on final at 10NM distance in 3000ft height? ");
    ...
    print("\n21. What's the surface area and volume of a 30cm x 1cm pizza? ");
    ...
    print("\n22. Which exoplanets are life-friendly and quite near? ");
